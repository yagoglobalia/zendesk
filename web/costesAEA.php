...
$g->select_command = "SELECT locata, vueloidar, vuelovueltar, vueloidae, vuelovueltae, ciaida, ciavuelta from reservas where (ciaida = 'AIR_EUROPA' or ciavuelta = 'AIR_EUROPA') AND (vueloidae = 0 or vuelovueltae=0)";
...
$col = array();
$col["title"] = "Cia Ida"; // caption of column, can use HTML tags too
$col["name"] = "ciaida"; // grid column name, same as db field or alias from sql
$col["width"] = "40"; // width on grid
$col["editable"] = false;
...
$col = array();
$col["title"] = "Cia Vuelta"; // caption of column, can use HTML tags too
$col["name"] = "ciavuelta"; // grid column name, same as db field or alias from sql
$col["width"] = "40"; // width on grid
$col["editable"] = false;
