...
$col = array();
$col["title"] = "Reserva"; // caption of column, can use HTML tags too
$col["name"] = "reservaasociada"; // grid column name, same as db field or alias from sql
$col["width"] = "40"; // width on grid
$col["editable"] = true;
...
$col["name"] = "fechamail"; // grid column name, same as db field or alias from sql
$col["width"] = "40"; // width on grid
$col["editable"] = true;
...
$col = array();
$col["title"] = "Caducidad"; // caption of column, can use HTML tags too
$col["name"] = "fechacaducidad"; // grid column name, same as db field or alias from sql
$col["width"] = "40"; // width on grid
$col["editable"] = true;
$cols[] = $col;   
